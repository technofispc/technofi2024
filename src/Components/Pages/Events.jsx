...
function Event(){
    ...
    return(
        ...
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row overflow-hidden cursor-pointer' onClick={() => navigate('/events/anatomy')}>
        ...
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row-reverse overflow-hidden cursor-pointer' onClick={() => navigate('/events/ascent')}>
        ...
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row overflow-hidden cursor-pointer' onClick={() => navigate('/events/byte')}>
          ...
          WebkitTextFillColor: 'transparent',
                    ...
                    Bytes of Brilliance, the sui generis of TECHNOFI includes a mandatory initial puzzle that provides a GPT API key needed to start development. The primary objective is to build a Generative AI (GENAI) product that generates structured documents or media (such as presentations, eBooks). The puzzles are based on fields like cryptography, steganography.
                </div>
            </div>
        </div>
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row-reverse overflow-hidden cursor-pointer' onClick={() => navigate('/events/mech')}>
            <img src="https://sivpthcvunwbhqmkmhee.supabase.co/storage/v1/object/sign/EventsPage/img/7.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJFdmVudHNQYWdlL2ltZy83LmpwZyIsImlhdCI6MTcyNTA5MjM2MSwiZXhwIjoxNzU2NjI4MzYxfQ.ZTmKezG0is0npLb3VunH6J6OpnTQ562a-nmKMpYH7cM&t=2024-08-31T08%3A19%3A22.326Z" alt="" className='h-full'/>
            <div className='flex justify-between items-center py-8 mx-8'>
                <div className='h-full flex justify-center flex-col'>
          ...
          WebkitTextFillColor: 'transparent',
                    ...
                    Prepare for an epic showdown between robotic warriors! In this thrilling competition, skilled engineers and programmers will pit their creations against one another in a battle of wits and technology. Witness the future of combat as these autonomous machines clash in a fierce arena.
                </div>
            </div>
        </div>
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row overflow-hidden cursor-pointer' onClick={() => navigate('/events/picto')}>
          ...
          WebkitTextFillColor: 'transparent',
                    ...
                    Welcome to Pictomania. The ultimate short video making event of the year. With the help of this event, we bring together creative minds to showcase their power in photography and video editing. Wheather you are a seasoned photographer or an enthusiastic filmmaker, PICTOMANIA is the perfect platform to share your vision and compete with what others have crafted.
                </div>
            </div>
        </div>
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row-reverse overflow-hidden cursor-pointer' onClick={() => navigate('/events/pseudo')}>
        ...
        <div className='h-52 w-5/6 border m-10 rounded-2xl border-yellow-orange flex flex-row overflow-hidden cursor-pointer' onClick={() => navigate('/events/chaos')}>
